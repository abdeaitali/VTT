...
input_file = '//vti.se/root/Mistrainfra/Data/Trafikdata/filter_traffic_data_vastrastambanan_2015.csv'
output_file = 'data_traffic_vastrastambanan_2015.csv'



# List of valid platssignatur in the order of travel
valid_platssignatur = ["G", "Bro", "Kän", "Cst"]
